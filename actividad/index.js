...
//Entry es para asumir qur recibe una entrada.
...
const hasDate = _.has(entries[2], "titulo")
//console.log(hasDate)
...
const filterByDevelopmentTag = _.filter(entries, function(entry){ 
    return _.includes(entry.tags,"Desarrollo")
})

filterByDevelopmentTag

const grouppedByAuthor = _.groupBy(filterByDevelopmentTag, "autor")
